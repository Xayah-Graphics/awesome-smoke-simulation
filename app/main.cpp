...
int main() {
    try {
        ...
        auto run_stable_step = [&]() {
            ...
            advect_density_desc.nx = stable_settings.desc.nx;
            advect_density_desc.ny = stable_settings.desc.ny;
            advect_density_desc.nz = stable_settings.desc.nz;
            advect_density_desc.cell_size = stable_settings.desc.cell_size;
            advect_density_desc.dt = stable_settings.desc.dt;
            advect_density_desc.boundary_x_min = stable_settings.desc.boundary_x_min;
            advect_density_desc.boundary_x_max = stable_settings.desc.boundary_x_max;
            advect_density_desc.boundary_y_min = stable_settings.desc.boundary_y_min;
            advect_density_desc.boundary_y_max = stable_settings.desc.boundary_y_max;
            advect_density_desc.boundary_z_min = stable_settings.desc.boundary_z_min;
            advect_density_desc.boundary_z_max = stable_settings.desc.boundary_z_max;
            advect_density_desc.density = stable_runtime.density;
            advect_density_desc.temporary_density = stable_runtime.temporary_density;
            advect_density_desc.temporary_previous_density = stable_runtime.temporary_previous_density;
            advect_density_desc.velocity_x = stable_runtime.velocity_x;
            advect_density_desc.velocity_y = stable_runtime.velocity_y;
            advect_density_desc.velocity_z = stable_runtime.velocity_z;
            advect_density_desc.block_x = stable_settings.desc.block_x;
            advect_density_desc.block_y = stable_settings.desc.block_y;
            advect_density_desc.block_z = stable_settings.desc.block_z;
            advect_density_desc.stream = stable_runtime.sim_stream;
            ...
            diffuse_density_desc.nx = stable_settings.desc.nx;
            diffuse_density_desc.ny = stable_settings.desc.ny;
            diffuse_density_desc.nz = stable_settings.desc.nz;
            diffuse_density_desc.cell_size = stable_settings.desc.cell_size;
            diffuse_density_desc.dt = stable_settings.desc.dt;
            diffuse_density_desc.diffusion = stable_settings.desc.diffusion;
            diffuse_density_desc.diffuse_iterations = stable_settings.desc.diffuse_iterations;
            diffuse_density_desc.boundary_x_min = stable_settings.desc.boundary_x_min;
            diffuse_density_desc.boundary_x_max = stable_settings.desc.boundary_x_max;
            diffuse_density_desc.boundary_y_min = stable_settings.desc.boundary_y_min;
            diffuse_density_desc.boundary_y_max = stable_settings.desc.boundary_y_max;
            diffuse_density_desc.boundary_z_min = stable_settings.desc.boundary_z_min;
            diffuse_density_desc.boundary_z_max = stable_settings.desc.boundary_z_max;
            diffuse_density_desc.density = stable_runtime.density;
            diffuse_density_desc.temporary_density = stable_runtime.temporary_density;
            diffuse_density_desc.temporary_pressure = stable_runtime.temporary_pressure;
            diffuse_density_desc.temporary_divergence = stable_runtime.temporary_divergence;
            diffuse_density_desc.block_x = stable_settings.desc.block_x;
            diffuse_density_desc.block_y = stable_settings.desc.block_y;
            diffuse_density_desc.block_z = stable_settings.desc.block_z;
            diffuse_density_desc.stream = stable_runtime.sim_stream;
            ...
            stable_ok(stable_fluids_advect_density_cuda(&advect_density_desc), "stable_fluids_advect_density_cuda");
            stable_ok(stable_fluids_diffuse_density_cuda(&diffuse_density_desc), "stable_fluids_diffuse_density_cuda");
        };
        ...
        auto run_visual_step = [&]() {
            ...
            advect_scalars_desc.nx = visual_settings.desc.nx;
            advect_scalars_desc.ny = visual_settings.desc.ny;
            advect_scalars_desc.nz = visual_settings.desc.nz;
            advect_scalars_desc.cell_size = visual_settings.desc.cell_size;
            advect_scalars_desc.dt = visual_settings.desc.dt;
            advect_scalars_desc.use_monotonic_cubic = visual_settings.desc.use_monotonic_cubic;
            advect_scalars_desc.density = visual_runtime.density;
            advect_scalars_desc.temperature = visual_runtime.temperature;
            advect_scalars_desc.velocity_x = visual_runtime.velocity_x;
            advect_scalars_desc.velocity_y = visual_runtime.velocity_y;
            advect_scalars_desc.velocity_z = visual_runtime.velocity_z;
            advect_scalars_desc.temporary_previous_density = visual_runtime.temporary_previous_density;
            advect_scalars_desc.temporary_previous_temperature = visual_runtime.temporary_previous_temperature;
            advect_scalars_desc.block_x = visual_settings.desc.block_x;
            advect_scalars_desc.block_y = visual_settings.desc.block_y;
            advect_scalars_desc.block_z = visual_settings.desc.block_z;
            advect_scalars_desc.stream = visual_runtime.sim_stream;
            ...
            smoke_ok(visual_simulation_of_smoke_advect_scalars_cuda(&advect_scalars_desc), "visual_simulation_of_smoke_advect_scalars_cuda");
        };
